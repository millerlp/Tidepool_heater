...
// Data wire is plugged into pin D3 (PD3) on the AVR
...
//*************************
#define MOSFET 8  // AVR digital pin D8 (PB0) used to turn on MOSFET
...
//  oled.begin(&Adafruit128x32, I2C_ADDRESS); // For 128x32 OLED screen
